...
function Sidebar({
  ...
  return (
    <>
      {/* Mobile nav, opened via SidebarTrigger/toggleSidebar. Always mounted so the
          desktop tree below never unmounts on resize - that's what lets it slide/fade
          out via CSS instead of vanishing instantly. */}
      ...
      <div
        ...
        data-slot="sidebar"
      >
        {/* This is what handles the sidebar gap on desktop. Below `md` it's always
            0-width (pure CSS, no JS breakpoint state) so main content fills the row
            and the transition below animates smoothly across the breakpoint too. */}
        <div
