...
import type { OccupancyData, SchedulerProjectData } from '../types/global'
...
export const getHourOccupancy = (
  ...
  const freeMinutes = takenHours
    ? 0
    : takenMinutes
      ? minutesInHour - takenMinutes
      : 0
