  ...
  return (
    ...
    >
      <StyledForm onSubmit={handleSubmit}>
        <StyledInnerWrapper>
          <StyledLabel htmlFor={formFieldsIds.peopleCount}>
            People count:{' '}
          </StyledLabel>
          <StyledInput
        ...
        <StyledInnerWrapper>
          <StyledLabel htmlFor={formFieldsIds.projectsPerYear}>
            Projects per year:{' '}
          </StyledLabel>
          <StyledInput
        ...
        <StyledInnerWrapper>
          <StyledLabel htmlFor={formFieldsIds.yearsCovered}>
            Years covered:{' '}
          </StyledLabel>
          <StyledInput
        ...
        <StyledInnerWrapper>
          <StyledLabel htmlFor={formFieldsIds.startDate}>
            Starting date{' '}
          </StyledLabel>
          <StyledInput
        ...
        <StyledInnerWrapper>
          <StyledLabel htmlFor={formFieldsIds.maxRecordsPerPage}>
            Records/page:{' '}
          </StyledLabel>
          <StyledInput
        ...
        <StyledInnerWrapper>
          <StyledLabel htmlFor={formFieldsIds.isFullscreen}>
            Fullscreen:{' '}
          </StyledLabel>
          <StyledCheckbox
