import { boxHeight } from '@src/components/Scheduler/constants'
import styled from 'styled-components'
import type { StyledLeftColumnItemWrapperProps, StyledTextProps } from './types'
...
export const StyledText = styled.p<StyledTextProps>`
  ...
  color: ${({ isMain, theme }) =>
    isMain ? theme.colors.textPrimary : theme.colors.placeholder};
