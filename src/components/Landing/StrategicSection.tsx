...
import { Activity, Cpu, Layers, MousePointer2, Scan } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <p className="max-w-xl text-lg text-blue-50 font-light italic leading-relaxed border-l-4 border-white/40 pl-8">
                "We don't just manage tasks; we architect outcomes. Mirama
                provides the computational backbone for teams that demand
                absolute structural integrity in their project lifecycle."
              </p>
