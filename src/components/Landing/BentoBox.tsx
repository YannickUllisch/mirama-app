    ...
    <div className="container mx-auto">
      <div className="flex flex-col gap-10">
        <div className="flex gap-4 flex-col items-start">
          <div>
            <Badge className="text-muted">Platform</Badge>
          </div>
          <div className="flex gap-2 flex-col">
            <h2 className="text-3xl text-text-inverted md:text-5xl tracking-tighter max-w-xl font-regular text-left">
              Everything you need to stay on track
            </h2>
            <p className="text-lg text-muted/60 max-w-xl lg:max-w-lg leading-relaxed tracking-tight text-left">
