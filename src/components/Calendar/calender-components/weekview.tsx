...
import EventModal, { type ColorScheme } from '../event-components/eventmodal'
          ...
          <div style={{ minWidth: '100%', display: 'table' }}>
            <div className="relative mb-2">
              ...
              <div
                ...
                style={{ display: 'none' }}
              >
                <span className="absolute left-0 transform -translate-x-full -translate-y-1/2 bg-primary text-primary-foreground text-xs px-1 rounded" />
              </div>
            </div>
          </div>
        </div>
...
export const Categories: { [key: string]: { class: string } } = {
  blue: {
    class:
      'bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200 border-l-blue-600 dark:border-l-blue-400',
  },
  green: {
    class:
      'bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200 border-l-green-600 dark:border-l-green-400',
  },
  yellow: {
    class:
      'bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200 border-l-yellow-600 dark:border-l-yellow-400',
  },
  purple: {
    class:
      'bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200 border-l-purple-600 dark:border-l-purple-400',
  },
}
