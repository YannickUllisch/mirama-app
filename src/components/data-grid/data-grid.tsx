...
import { DataGridColumnHeader } from '@src/components/data-grid/data-grid-column-header'
import { DataGridContextMenu } from '@src/components/data-grid/data-grid-context-menu'
import { DataGridPasteDialog } from '@src/components/data-grid/data-grid-paste-dialog'
import { DataGridRow } from '@src/components/data-grid/data-grid-row'
import { DataGridSearch } from '@src/components/data-grid/data-grid-search'
import { useAsRef } from '@src/hooks/use-as-ref'
import type { useDataGrid } from '@src/hooks/use-data-grid'
import {
  flexRender,
...
import type { Direction } from '@src/types/data-grid'
...
export function DataGrid<TData>({
  ...
  return (
    ...
    >
      ...
      {/** biome-ignore lint/a11y/useSemanticElements: <x> */}
      <div
        role="grid"
