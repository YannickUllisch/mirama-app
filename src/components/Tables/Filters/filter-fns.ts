...
export const inEnumSetFilterFn: FilterFn<unknown> = (
  row,
  columnId,
  filterValue: string[],
) => {
...
inEnumSetFilterFn.autoRemove = (val: unknown) =>
...
export const inNumberRangeFilterFn: FilterFn<unknown> =
  filterFns.inNumberRange as FilterFn<unknown>
