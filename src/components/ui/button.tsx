...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-3 whitespace-nowrap transition-all focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] select-none',
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          'rounded-xl bg-secondary text-white shadow-xs hover:opacity-90 font-bold tracking-tight',
        ...
        destructive:
          'rounded-xl border border-red-200 dark:border-red-900/50 bg-red-50/50 dark:bg-red-950/20 text-red-600 dark:text-red-400 font-medium tracking-tight hover:bg-red-500 hover:text-white dark:hover:bg-red-600 transition-all duration-200 shadow-xs shadow-red-500/5',
        link: 'relative h-auto p-0 text-[11px] font-bold  text-text/70 underline-offset-4 hover:underline transition-all',
