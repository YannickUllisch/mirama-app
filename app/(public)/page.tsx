  ...
  return (
    <>
      ...
      <div className="relative h-32 w-full z-40 overflow-x-clip">
        <div className="absolute top-[130px] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] py-7 bg-secondary -rotate-2 shadow-[0_20px_50px_rgba(0,0,0,0.3)] border-y-2 border-white/20">
