...
import { SectionDivider } from '../../../../src/modules/shared/components/Background/SectionDivider'
  ...
  return (
    <section className="relative w-full py-24 lg:py-40 bg-secondary overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-40 -left-20 w-[140%] h-0.5 bg-white/5 rotate-6" />
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7 space-y-8">
              ...
              <p className="max-w-xl text-lg text-blue-50 font-light italic leading-relaxed border-l-4 border-white/40 pl-8">
                ...
                teams to operate with the discipline of an enterprise-grade
                organization."
              </p>
