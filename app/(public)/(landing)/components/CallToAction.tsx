  ...
  return (
    <section className="relative w-full py-24 lg:py-40 bg-primary overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div className="absolute top-1/2 -left-20 w-[140%] h-0.5 bg-white/20 rotate-12" />
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-0 translate-y-px">
        ...
        <div className="absolute bottom-0 right-0 w-full h-px bg-white/20 -rotate-6 origin-right -translate-y-2.5 lg:-translate-y-5" />
      </div>
    </section>
  )
}
