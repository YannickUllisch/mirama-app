    ...
    <section className="relative w-full min-h-[calc(100vh-80px)] flex flex-col justify-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 relative z-10 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 relative h-150">
                  ...
                  <div className="p-8 space-y-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-12 gap-6">
                      ...
                      <div className="col-span-5 space-y-6">
                        ...
                        <div className="p-6 bg-white rounded-2xl border border-slate-100 shadow-[0_10px_30px_rgba(0,0,0,0.04)] min-h-75 space-y-6">
