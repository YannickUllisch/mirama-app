...
const ProjectPage: FC<ProjectPageProps> = async ({
  params,
}: { params: { name: string } }) => {
  ...
  console.log(project) // This will log the dynamic route parameter

  return <div>yoo, {project?.name}</div>
}
...
//   // TODO Make the project page itself server side, and make the Tab portion reusable.
