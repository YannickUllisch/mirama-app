// app/(app)/organization/[organizationId]/settings/policies/_components/PolicyScopeTab.tsx
'use client'
...
export const PolicyScopeTab = ({ scope }: { scope: AccessScope }) => {
  ...
  const policiesBase = `/organization/${activeOrganizationId}/settings/policies`
