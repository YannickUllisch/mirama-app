import { ContactRequestSchema } from '@/serverOld/domain/contactSchema'
import { SNSService } from '@/serverOld/services/general/snsService'
...
export const ContactController = {
   ...
   */
  sendContactRequest: async (req: NextRequest, logger: Logger) => {
